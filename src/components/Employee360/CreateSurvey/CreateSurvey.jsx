...
import { Questionlooks, Required, Choices, CopyText } from './CreateSurveyStyle'
...
const CreateSurvey = ({ notify }) => {
  ...
  return (
    <>
      {showSurveyURL ? (
        <div className="survey_main h-100 ">
          <Grid container direction="row" justify="space-around" spacing={5}>
            <Grid item xs={12} sm={12} md={8} spacing={3}>
              <OfficerCard>
                ...
                <CopyText className="pt-5 pb-3 text-left">
      ...
      <OfficerDialog
        ...
        content={
          <>
            ...
            <Questions count={1} item={newQuestionData} id={'employee-survey-question'} />
          </>
        }
      />
      ...
      <OfficerDialog
        ...
        content={
          <>
            ...
            <Questionlooks className="pt-5">This is How Question Will Look Like :</Questionlooks>
            <Questions item={updateQuestion} count={1} id={'employee-survey-question-update'} />
          </>
        }
      />
    </>
