...
import { Question, QuestionNumber, Para, Heading, Chart } from './CommunitySurveyResponseReportStyle'
import { getAPI } from '../../../utils/api'
import { communitySurveyResponseReport } from '../../../utils/apiUrls'
...
const CommunitySurveyResponseReport = () => {
  ...
  const fetchReport = async () => {
    ...
    const response = await getAPI(`${communitySurveyResponseReport}${reportId}`)
  ...
  const showReviews = () => {
    ...
    for (let i = 0; i < info.length; i = i + 2) {
      ...
      List.push(
        <Grid key={`data-report-community${i}`} container direction="row" justify="space-around" spacing={5}>
            ...
            <Grid item md={7} sm={12}>
              ...
              <div className="d-flex flex-column justify-contet-center align-items-center ">
                ...
                <OfficerButton
                  ...
                  variant="large"
                  click={() => {
                    history.push(`/community-feedback-response/${reportId}`)
                  }}
                />
              </div>
            </Grid>
